...
--student_ckpt_path /data1/chenxiao/LLaRA/checkpoints/steam_llama2_distillation_stage2_klcosloss/epoch=04-metric=0.449.ckpt \
--ckpt_dir ./checkpoints/steam_llama2_distillation_stage3/ \
