...
class DPOTrainer(Trainer):
    ...
    def get_batch_metrics(
        ...
        metrics = {}
        # batch keys： dict_keys(['prompt', 'chosen', 'rejected1', 'rejected2', 'rejected3', 
        # 'chosen_response_only', 'rejected1_response_only', 'rejected2_response_only', 'rejected3_response_only', 
        # 'chosen_input_ids', 'chosen_attention_mask', 'chosen_labels', 
        # 'prompt_input_ids', 'prompt_attention_mask', 
        # 'rejected1_input_ids', 'rejected1_attention_mask', 'rejected1_labels', 
        # 'rejected2_input_ids', 'rejected2_attention_mask', 'rejected2_labels', 
        # 'rejected3_input_ids', 'rejected3_attention_mask', 'rejected3_labels'])
        
        # print('prompt', batch['prompt'])
        # print('chosen',batch['chosen'])
        # print('rejected1',batch['rejected1'])
        # print('chosen_response_only',batch['chosen_response_only'])
        (
            policy_chosen_logps,
