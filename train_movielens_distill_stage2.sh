...
--ckpt_dir ./checkpoints/movielens_llama3_peft_distill_stage2_crosskd/ \
--ckpt_path /data/cx/checkpoints/movielens_llama3_peft/epoch=04-metric=0.542.ckpt \
--ckpt_head_path /data/cx/checkpoints/movielens_llama3_peft_distill_stage1_multilayer/epoch=02-metric=0.667.ckpt \
